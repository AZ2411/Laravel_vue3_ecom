        ...
        <form @submit.prevent="auth.handleForgotPassword(email)" class="my-10">
            <div class="flex flex-col space-y-5">
                <label for="email">
                    ...
                    <input id="email" v-model="email" name="email" type="email" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter email address">
                </label>
